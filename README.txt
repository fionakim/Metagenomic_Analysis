...
#****
Not Used: -Indexing of filtered contigs
qsub 7_Bowtie2_index.sh
bowtie2-build HU100_S17_scaffolds.fasta.Filtered.fna HU100_S17_Bowtie_assembly
# Not Used: -Mapping of reads on contigs to extract out the unmapped reads
qsub 7_Bowtie2_Map.sh
...
Rscript Gene_proportions.R (4.sh)
...
ads 24 -max_target_seqs 1 (Query database was divided into multiple parts)
...
blastp -query ~/Metagenomic/Final_NR_GeneSet/xae1 -db ~/Databases/CaZyDB_130918/CAZyDB.07202017.cdhit.fa -outfmt "6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qcovs" -out xae1.Blast_out -num_threads 24 -max_target_seqs 1
...
./mOTUs.pl --sample-file SAMPLE_FILE --processors=120
SAMPLE_FILE (Name all folders containing R1 and R2 files)
2009_106
2009_107
... so on
